...
### Materialized Models
Each transformation job run materializes **26** models if you enable all components of this data model. This count includes all staging, intermediate, and final models materialized as either `view` or `table`.
<!--section-end-->
